      ...
      <div class="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-2">
        <div class="flex items-center justify-between">
          ...
          <div class="flex items-center space-x-2 md:space-x-4">
            ...
            <button 
              type="button" 
              class="p-2 rounded-full hover:bg-gray-100 dark:hover:bg-brand-charcoal-gray/40 focus:outline-none"
              on:click={() => fetchSnippets()}
            ...
            <button 
              ...
              on:click={() => { isDarkMode = !isDarkMode; updateTheme(isDarkMode); }}
