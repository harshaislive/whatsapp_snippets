    ...
    <form class="mt-8 space-y-6" on:submit|preventDefault={handleLogin}>
      ...
      <div>
        <button
          type="submit"
          disabled={loading}
          class="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-brand-forest-green hover:bg-brand-forest-green/90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-forest-green dark:bg-brand-light-blue dark:hover:bg-brand-light-blue/90 dark:focus:ring-brand-light-blue dark:ring-offset-brand-dark-earth disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-200"
        >
          {#if loading}
